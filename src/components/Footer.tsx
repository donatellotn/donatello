...
export const Footer = () => {
  ...
  return (
    <>
      ...
      <footer
        id="footer"
        style={{ background: '#3A2A22', color: 'rgba(248,245,240,0.6)', padding: '56px 0 28px' }}
      >
          ...
          >
            ...
            <div className="flex flex-col gap-3.5">
              ...
              <div className="flex gap-2.5 mt-2">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(248,245,240,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Navigation */}
            <div>
              <h4 style={{ fontFamily: '"Inter",sans-serif', fontSize: '0.72rem', fontWeight: 600, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(248,245,240,0.4)', marginBottom: '18px' }}>
                {tr('footer_nav')}
              </h4>
              <div className="flex flex-col gap-2.5">
                {navLinks.map((link) => (
                  <Link
                    ...
                    style={{ fontSize: '0.85rem', color: 'rgba(248,245,240,0.6)' }}
                  >
                    {link.label}
                  </Link>
                ))}
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <span style={{ fontSize: '0.85rem' }}>{tr('contact_address_val')}</span>
                <span style={{ fontSize: '0.85rem' }}>{tr('footer_hours_val')}</span>
              </div>
            </div>
          </div>
